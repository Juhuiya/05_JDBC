...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        /* PreparedStatement는 Statement와 달리 placeholder(위치홀더, ?)를 활용한 하나의 문자열 형태로 쿼리를 작성 */
        String query = "SELECT MENU_NAME, MENU_PRICE FROM tbl_menu WHERE MENU_CODE = ?"; // where이 붙으면 완전한 쿼리가 아님.
